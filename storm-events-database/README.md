...
### Background
This notebook demonstrates how to analyze the Storm Events Database, which is stored as Parquet files on Google Cloud Storage. Using Python and DuckDB, the notebook covers how to read in the data, query via SQL, and save the results. This dataset is public and can be accessed directly here:
https://console.cloud.google.com/storage/browser/noaa-ncei-ipg/notebooks/data/stormevents.
